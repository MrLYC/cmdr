...
type CommandFunc func(context.Context, *model.CommandMutation) (model.Value, error)

// Mutate calls f(ctx, m).
func (f CommandFunc) Mutate(ctx context.Context, m model.Mutation) (model.Value, error) {
	mv, ok := m.(*model.CommandMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *model.CommandMutation", m)
	}
	return f(ctx, mv)
}
