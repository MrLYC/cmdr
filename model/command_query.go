...
func (cgb *CommandGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("model: CommandGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CommandGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{command.Label}
	default:
		err = fmt.Errorf("model: CommandGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CommandGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("model: CommandGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CommandGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{command.Label}
	default:
		err = fmt.Errorf("model: CommandGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CommandGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("model: CommandGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CommandGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{command.Label}
	default:
		err = fmt.Errorf("model: CommandGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CommandGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("model: CommandGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CommandGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{command.Label}
	default:
		err = fmt.Errorf("model: CommandGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CommandSelect) Strings(ctx context.Context) ([]string, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("model: CommandSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CommandSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{command.Label}
	default:
		err = fmt.Errorf("model: CommandSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CommandSelect) Ints(ctx context.Context) ([]int, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("model: CommandSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CommandSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{command.Label}
	default:
		err = fmt.Errorf("model: CommandSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CommandSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("model: CommandSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CommandSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{command.Label}
	default:
		err = fmt.Errorf("model: CommandSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CommandSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("model: CommandSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CommandSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{command.Label}
	default:
		err = fmt.Errorf("model: CommandSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
